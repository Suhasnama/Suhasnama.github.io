...
I am a Front-end Focused - FullStack Software Engineer with an experience of 5.7 years, currently work with Barclays. In my current role I'm working with Javascript, Typescript, React.js, Redux & Redux Sagas, Go lang.
...
I also love solving data-structures problem solving , you can find me on leetcode with username [suhasNama](https://leetcode.com/u/suhasNama/)
...
<p align='left'>
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/9/93/Amazon_Web_Services_Logo.svg" height='70' width="auto" alt="AWS"> 
...
### **FullStack Software Engineer - Frontend Foucsed**
### Barclays
- Contributed to development of Agents Desktop UI (React.js) application used
by Contact Center Agents answering **2M phone calls**, for Barclays US
Consumer Bank.
- Major contributions on **making** the Barclays US **Contact Center Multi Region
Resilient**. Which in-turn helped **serve customers** even during the **biggest AWS
Outage** on Oct 20 (i.e., Diwali 2025)
Delivered a UI project for a chat solution migration within a tight deadline,
**saving bank +1M £** on legacy platform contractrenewal, in turn helping in an
...
I love understanding how real time tech products work at scale. So I watch tech talks from their engineering teams.
